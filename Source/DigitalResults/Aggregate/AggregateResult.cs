...
/// <summary>
/// Aggregates multiple Results allowing the overall results to be evaluated together
/// </summary>
public class AggregateResult
{
    private readonly List<Result> mResults;

    /// <summary>
    /// A list of the related results
    /// </summary>
    public ReadOnlyCollection<Result> Results => mResults.AsReadOnly();
    ...
    public AggregateResult(List<Result> results)
    {
